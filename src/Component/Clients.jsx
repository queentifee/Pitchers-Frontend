...
const Clients = () => {
  ...
  return (
    ...
    <div className="relative mt-20 border-b border-neutral-800 min-h-[200px]">
       ...
       <div className="text-center text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-20 tracking-wide">
        
       <span className="bg-gradient-to-r from-orange-500 to-green-800 text-transparent bg-clip-text">
       Our works in numbers
          </span>
      ...
      {/* <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-white text-center w-full max-w-5xl"> */}
        ...
        >
          <CountUp start={0} end={140} duration={2} key={replay} className="text-3xl text-green-700 font-bold mt-2" />
        ...
        <div
          ...
          onMouseEnter={() => setReplay(!replay)}
        >
          <CountUp start={0} end={130} duration={2} key={replay} className="text-3xl text-orange-500 font-bold mt-2" />
        ...
        <div
          ...
          onMouseEnter={() => setReplay(!replay)}
        >
          <CountUp start={0} end={100} duration={2} key={replay} className="text-3xl text-orange-500 font-bold mt-2" />
        ...
        <div
          ...
          onMouseEnter={() => setReplay(!replay)}
        >
          <CountUp start={0} end={80} duration={2} key={replay} className="text-3xl text-green-700 font-bold mt-2" />
